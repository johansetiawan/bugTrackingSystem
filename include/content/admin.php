	...
	<article>   
		...
		<div class="cont">
			...
			<p>
				...
				<b>country : </b><?php echo $_SESSION['user']['COUNTRY']; ?><br>
				<b>adress : </b><?php echo $_SESSION['user']['ADDRESS'].'- '.$_SESSION['user']['POSTAL_CODE']; ?><br>
				<b>phone : </b><?php echo $_SESSION['user']['PHONE']; ?><br>
				<br>
			</p>
		</div>
	</article>